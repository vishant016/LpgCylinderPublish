...
namespace LPGCylinderSystem.Areas.Identity.Pages.Account
{
    ...
    public class ForgotPasswordModel : PageModel
    {
        ...
        public ForgotPasswordModel(UserManager<ApplicationUser> userManager, ClassRepository<ApplicationUser> classRepository, IEmailSender emailSender)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                _classRepository.SendMailForPaper(
                    Input.Email,
                    "Reset Password",
